...
global.owner = process.env.OWNER_NUMBER  || '94769089430' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=mMcEQDZb#8byHnEvaPsurTrmpq5BH-RUg_GXqVhI7iEhfOTf3Blk' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94724659430,94769089430" : process.env.MODERATORS ,    
